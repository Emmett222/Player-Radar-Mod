package net.emmett222.playerradarmod;
...
@Mod(PlayerRadarMod.MOD_ID)
public class PlayerRadarMod {
    public static final String MOD_ID = "playerradarmod";
    public static final Logger LOGGER = LogUtils.getLogger();

    public PlayerRadarMod() {
